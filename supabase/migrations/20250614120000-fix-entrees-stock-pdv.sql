...
-- Ajouter une colonne pour les points de vente dans les entrées de stock
...
-- Modifier la contrainte pour que soit entrepot_id soit point_vente_id soit renseigné
ALTER TABLE public.entrees_stock 
