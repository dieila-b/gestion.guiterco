...
-- Ajout du champ de suivi de livraison à la table factures_vente si non déjà présent
ALTER TABLE public.factures_vente
ADD COLUMN IF NOT EXISTS statut_livraison character varying DEFAULT 'livree';

-- Ajout dans la fonction SQL :
