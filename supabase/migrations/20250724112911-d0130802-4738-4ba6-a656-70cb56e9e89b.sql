-- Correction des policies RLS pour les utilisateurs internes (avec types corrects)
...
CREATE OR REPLACE FUNCTION public.get_internal_user_by_id(p_user_id UUID)
RETURNS TABLE(
  id UUID,
  user_id UUID,
  email TEXT,
