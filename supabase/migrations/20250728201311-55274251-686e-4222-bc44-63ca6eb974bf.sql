-- Vérifier et corriger les politiques RLS pour le système de permissions

-- 1. Vérifier et activer RLS sur la table roles si nécessaire
ALTER TABLE public.roles ENABLE ROW LEVEL SECURITY;

-- 2. Supprimer les anciennes politiques et créer des nouvelles politiques permissives pour la gestion des permissions
...
-- 3. Vérifier et corriger les politiques pour role_permissions
...
-- 4. S'assurer que les tables liées aux permissions ont des politiques appropriées
-- Table permissions déjà configurée selon le contexte

-- 5. Créer ou mettre à jour la table user_roles pour la gestion des utilisateurs
...
-- 6. Créer une vue pour faciliter la vérification des permissions utilisateur
...
-- 7. Créer une fonction pour vérifier les permissions
...
-- 8. Trigger pour mettre à jour updated_at sur user_roles
