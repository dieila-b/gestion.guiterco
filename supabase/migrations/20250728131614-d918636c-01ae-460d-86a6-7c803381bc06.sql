...
-- 2. Créer une fonction sécurisée pour vérifier les permissions
...
-- 3. Supprimer les politiques ultra-permissives problématiques et les remplacer par des politiques basées sur les permissions
...
-- 4. Assigner automatiquement toutes les permissions au rôle Administrateur
DO $$
DECLARE
    admin_role_id UUID;
    perm RECORD;
...
-- 5. Créer des permissions de base si elles n'existent pas
...
-- 6. Vérifier que tous les utilisateurs actifs ont bien un rôle
...
-- 7. Grant des permissions nécessaires
