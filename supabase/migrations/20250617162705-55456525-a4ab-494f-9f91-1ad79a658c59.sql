...
-- Ajouter une colonne pour stocker les quantités livrées dans chaque ligne de facture
ALTER TABLE public.lignes_facture_vente 
ADD COLUMN IF NOT EXISTS quantite_livree INTEGER DEFAULT 0;

-- Mettre à jour la fonction get_factures_vente_with_details pour inclure les quantités livrées
