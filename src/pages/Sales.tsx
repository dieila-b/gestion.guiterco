...
import FacturesPrecommandes from '@/components/sales/FacturesPrecommandes';
      ...
      <div className="space-y-4">
        ...
        >
          <TabsList className="grid grid-cols-7 w-full">
            ...
            <TabsTrigger value="factures-precommandes">Factures Précommandes</TabsTrigger>
          ...
          <TabsContent value="factures-precommandes" className="mt-6">
            <FacturesPrecommandes />
          </TabsContent>
