...
const NewClientForm: React.FC<NewClientFormProps> = ({ onSuccess, onCancel }) => {
  ...
  return (
    <div className="bg-gray-900 text-white p-8 rounded-lg max-w-4xl w-full mx-auto">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            {/* Statut Client */}
            <div>
              <Label htmlFor="statut_client" className="text-blue-300 mb-2 block text-sm font-medium">
                Statut Client
              </Label>
            ...
            {/* Nom du contact */}
            <div>
              <Label htmlFor="nom" className="text-blue-300 mb-2 block text-sm font-medium">
              ...
              <Input
                ...
                required
                className="bg-gray-800 border-gray-600 text-white placeholder:text-gray-400 h-10"
              />
            </div>

            {/* Email */}
            <div>
              <Label htmlFor="email" className="text-blue-300 mb-2 block text-sm font-medium">
                Email
              </Label>
              <Input
                id="email"
            ...
            {/* Téléphone */}
            <div>
              <Label htmlFor="telephone" className="text-blue-300 mb-2 block text-sm font-medium">
                Téléphone
              </Label>
              <Input
                id="telephone"
            ...
            {/* Ville */}
            <div>
              <Label htmlFor="ville" className="text-blue-300 mb-2 block text-sm font-medium">
                Ville
              </Label>
              <Input
                id="ville"
          ...
          <div className="space-y-4">
            {/* Nom de l'entreprise */}
            <div>
              <Label htmlFor="nom_entreprise" className="text-blue-300 mb-2 block text-sm font-medium">
                Nom de l'entreprise
              </Label>
              <Input
                id="nom_entreprise"
            ...
            {/* Type de Client */}
            <div>
              <Label htmlFor="type_client" className="text-blue-300 mb-2 block text-sm font-medium">
                Type de Client
              </Label>
            ...
            {/* WhatsApp */}
            <div>
              <Label htmlFor="whatsapp" className="text-blue-300 mb-2 block text-sm font-medium">
                WhatsApp
              </Label>
              <Input
                id="whatsapp"
            ...
            {/* Adresse */}
            <div>
              <Label htmlFor="adresse" className="text-blue-300 mb-2 block text-sm font-medium">
                Adresse
              </Label>
              <Input
                id="adresse"
            ...
            {/* Limite de crédit */}
            <div>
              <Label htmlFor="limite_credit" className="text-blue-300 mb-2 block text-sm font-medium">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="0"
                  className="bg-gray-800 border-gray-600 text-white placeholder:text-gray-400 h-10 pr-12"
                />
        ...
        <div className="flex justify-end space-x-4 pt-6 border-t border-gray-700">
          <Button 
            ...
            variant="outline" 
            onClick={onCancel}
            className="bg-transparent border-gray-600 text-gray-300 hover:bg-gray-800 px-6"
          >
            Annuler
          </Button>
          <Button 
