...
import { useCashOperations, useAddCashOperation } from "@/hooks/useCashOperations";
...
const CaissesTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Dashboard - encadrés fond de caisse et encaissement jour */}
