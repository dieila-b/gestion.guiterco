...
const CreateSortieDialog: React.FC = () => {
  ...
  const { data: categories = [] } = useCategoriesFinancieres('sortie');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Sortie créée",
        description: "La sortie financière a été enregistrée avec succès",
      });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Nouvelle sortie financière</DialogTitle>
        </DialogHeader>
...
export default CreateSortieDialog;
