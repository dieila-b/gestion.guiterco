...
export const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: Package, label: 'Ventes', href: '/ventes' },
    { icon: Warehouse, label: 'Stock', href: '/stock' },
    { icon: CreditCard, label: 'Achats', href: '/achats' },
    { icon: Users, label: 'Clients', href: '/clients' },
    { icon: DollarSign, label: 'Caisse', href: '/caisse' },
    { icon: TrendingUp, label: 'Marges', href: '/marges' },
