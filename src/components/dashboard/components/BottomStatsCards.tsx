          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {isLoading ? <Skeleton className="h-8 w-24" /> : formatCurrency(stats?.stockGlobalAchat || 0)}
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {isLoading ? <Skeleton className="h-8 w-24" /> : formatCurrency(stats?.stockGlobalVente || 0)}
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {isLoading ? <Skeleton className="h-8 w-24" /> : formatCurrency(stats?.margeGlobaleStock || 0)}
              </p>
            </div>
          </div>
        </CardContent>
