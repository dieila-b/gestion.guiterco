...
import { useBonsLivraison } from '@/hooks/usePurchases';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Bons de livraison</h2>
        <Button>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{bon.transporteur || 'Non spécifié'}</p>
                </div>
              </div>
              {bon.numero_suivi && (
                <div className="mt-4">
                  <p className="text-muted-foreground text-sm">Numéro de suivi</p>
                  <p className="text-sm font-mono">{bon.numero_suivi}</p>
                </div>
              )}
            </CardContent>
          </Card>
